...
export const site = {
  ...
  social: {
    handle: "@solvicosoft",
    facebook: "https://www.facebook.com/profile.php?id=61583133316217",
    youtube: "https://www.youtube.com/@SolvicoSoft",
    linkedin: "https://linkedin.com/company/solvicosoft",
  },

  contact: {
    email: "solvicosoft_agency@gmail.com",
    phone: "+880 1760 661659",
    phoneHref: "+8801760661659",
    addressLines: [
  ...
  rotatingItems: [
    ...
    {
      text: "HMMS",
      subtext: "Hall Meal Management System — A complete digital platform for managing student meals, meal schedules, costs, attendance, and hall operations in real time.",
    },

    {
      text: "OBE_SOFT",
      subtext: "Outcome Based Education System — A comprehensive platform for managing OBE activities, course outcomes, program outcomes, attainment analysis, CQI, and accreditation requirements.",
    },

    {
      text: "VitaCraft",
      subtext: "A Dynamic CV Generator — A free and user-friendly platform that helps anyone create professional, customizable CVs quickly and easily."
    },
...
"One stack across every product. A fix to the way we handle authentication, reporting or deployment lands everywhere at once, and nothing in the catalogue is left on a version nobody remembers how to build.",
  ...
  leadership: [
    ...
    testimonials: [
      {
        name: "Marzia Momo",
        role: "Student | Bonolota Hall, BAUET",
      ...
      {
        name: "Mohammed Golam Sarwar Bhuyan",
        role: "Faculty | Teachers Mess, BAUET",
